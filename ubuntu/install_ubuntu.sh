...
apt purge -y aisleriot bluez bluez-alsa bluez-cups bluez-gstreamer eog evolution-data-server gnome-bluetooth gnome-games-data gnome-orca gnome-sudoku gnomine gwibber mahjongg onboard pulseaudio-module-bluetooth python-ubuntuone-client python-ubuntuone-control-panel python-ubuntuone-storageprotocol rhythmbox-ubuntuone xterm ubuntuone-client ubuntuone-client-gnome ubuntuone-control-panel ubuntuone-control-panel-qt ubuntuone-couch unity unity-asset-pool unity-common unity-lens-application unity-lens-files unity-lens-music unity-lens-photos unity-lens-shopping unity-lens-video unity-scope-gdocs unity-scope-video-remote unity-services
apt autoremove -y
